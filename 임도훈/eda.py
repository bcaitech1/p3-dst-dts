...
def draw_EDA(domain_counter: dict,o_domain_counter: dict):
    ...
    plt.legend()
    #현재 디렉토리에 사진 저장
    plt.savefig('domain_graph_plot.png')
    plt.show()
